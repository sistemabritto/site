...
const AGENTS = [
 ...
 detail: 'Analisa concorrentes, sugere ângulos, posiciona sua marca no ponto certo. Sabe quando é hora de vender e quando é hora de educar.',
 ...
 detail: 'Sabe vender sem parecer vendedor. Constrói narrativas que fazem o cliente sentir que precisa do produto agora.',
 ...
 detail: 'Responde comentários, qualifica DMs e identifica quando alguém tá pronto pra comprar. Monitora menções e mantém a comunidade viva.',
 ...
 detail: 'Monta o calendário da semana inteira. Se um horário não performa, ele muda. Se um formato bomba, ele replica.',
...
const PIPELINE_STEPS = [
 { id: 'idea', label: 'Ideia', desc: 'IA pesquisa trends e ângulos' },
 { id: 'draft', label: 'Rascunho', desc: 'Agentes criam copy + visual' },
 { id: 'review', label: 'Revisão', desc: 'Validação de tom e marca' },
 { id: 'approved', label: 'Aprovado', desc: 'Sua aprovação (ou automático)' },
 { id: 'scheduled', label: 'Agendado', desc: 'Melhor horário por rede' },
 { id: 'published', label: 'Publicado', desc: 'No ar, em todas as redes' },
 { id: 'analyzed', label: 'Analisado', desc: 'Métricas + ajuste automático' },
];
...
export default function SocialJobs() {
 ...
 <span className="w-2 h-2 bg-orange-400 rounded-full animate-pulse" />
 <span className="text-orange-400 text-xs font-bold uppercase tracking-wider">Vitrine viva</span>
 </span>
 ...
 {/* Mockup do sistema — calendário + pipeline */}
 <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
 {/* Coluna esquerda: Calendário editorial */}
 <div className="bg-[#0a0a0a]/80 border border-white/[0.06] rounded-2xl p-6">
 <div className="flex items-center justify-between mb-6">
 <h3 className="text-white font-bold text-lg">Calendário Editorial</h3>
 <span className="text-orange-400 text-xs font-bold uppercase tracking-wider bg-orange-500/10 px-3 py-1 rounded-full border border-orange-500/20">Esta semana</span>
 </div>
 <div className="space-y-3">
 {[
 { day: 'Seg', status: 'published', title: 'Como IA virou o braço direito...', networks: 'YT · IG · TK' },
 { day: 'Ter', status: 'published', title: '3 sinais que sua equipe...', networks: 'LI · X' },
 { day: 'Qua', status: 'scheduled', title: 'Automação na prática: case...', networks: 'YT · IG · TK · LI' },
 { day: 'Qui', status: 'approved', title: 'O guia definitivo de Social...', networks: 'IG · TK' },
 { day: 'Sex', status: 'draft', title: 'A IA que cria conteúdo...', networks: 'YT · LI · X' },
 ].map((item, i) => (
 <div key={i} className="flex items-center gap-4 bg-[#111111]/60 rounded-xl p-4 border border-white/[0.04]">
 <div className="text-center min-w-[50px]">
 <div className="text-gray-500 text-xs uppercase tracking-wider">{item.day}</div>
 </div>
 <div className="flex-1">
 <div className="text-white font-semibold text-sm mb-1">{item.title}</div>
 <div className="text-gray-500 text-xs">{item.networks}</div>
 </div>
 ...
 item.status === 'approved' ? 'bg-orange-500/10 text-orange-400 border border-orange-500/20' :
 ...
 {/* Coluna direita: Pipeline + métricas */}
 <div className="space-y-6">
 {/* Pipeline de conteúdo */}
 <div className="bg-[#0a0a0a]/80 border border-white/[0.06] rounded-2xl p-6">
 <h3 className="text-white font-bold text-lg mb-6">Pipeline de Conteúdo</h3>
 <div className="space-y-4">
 {PIPELINE_STEPS.map((step, i) => (
 <div key={step.id} className="flex items-center gap-4">
 <div className={`w-10 h-10 rounded-xl flex items-center justify-center text-sm font-bold flex-shrink-0 ${
 activePipeline === step.id
 ? 'bg-orange-500 text-black'
 : 'bg-[#111111] text-gray-400 border border-white/[0.06]'
 }`}>
 ...
 {/* Métricas rápidas */}
 <div className="bg-[#0a0a0a]/80 border border-white/[0.06] rounded-2xl p-6">
 <h3 className="text-white font-bold text-lg mb-4">Métricas da semana</h3>
 <div className="grid grid-cols-3 gap-4">
 <div className="text-center">
 <div className="text-2xl font-bold text-orange-400">24</div>
 <div className="text-gray-500 text-xs">Posts publicados</div>
 </div>
 <div className="text-center">
 <div className="text-2xl font-bold text-orange-400">5</div>
 <div className="text-gray-500 text-xs">Redes ativas</div>
 </div>
 <div className="text-center">
 <div className="text-2xl font-bold text-orange-400">12%</div>
 <div className="text-gray-500 text-xs">Crescimento alcance</div>
 </div>
 </div>
 </div>
 </div>
 ...
 <span className="inline-flex items-center gap-2 bg-orange-500/15 border border-orange-500/25 rounded-full px-4 py-2 mb-6">
 <span className="w-2 h-2 bg-orange-400 rounded-full animate-pulse" />
 <span className="text-orange-400 text-xs font-bold uppercase tracking-wider">Do conteúdo ao lead</span>
 </span>
 <h2 className="text-3xl sm:text-4xl font-bold text-white mb-4">Conteúdo sem distribuição não vira cliente.</h2>
 <p className="text-gray-400 text-lg max-w-2xl mx-auto">
 O SocialJobs cria a consistência que alimenta tráfego orgânico e campanhas pagas. Transforme posts em criativos, threads em campanhas e vídeos curtos em topo de funil.
 </p>
 </div>
