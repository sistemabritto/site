 ...
 * Conforme políticas de privacidade da Meta (Facebook/Instagram) para apps conectados
 */
          ...
          <div className="prose-dark space-y-10 text-neutral-200 text-sm leading-relaxed">
            ...
            <section>
              ...
              <ul className="list-disc pl-5 mt-3 space-y-2">
                ...
                <li>Encontre o aplicativo <strong className="text-white">Sistema Britto / Workflow API</strong></li>
