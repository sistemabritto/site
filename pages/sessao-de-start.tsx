    ...
    <main className="min-h-screen bg-surface-950 px-5 py-5 text-white sm:py-8">
      <div className="mx-auto max-w-5xl">
        ...
        <header className="grid gap-10 py-8 sm:py-16 lg:grid-cols-[1.2fr_1fr] lg:items-center">
          ...
          <h1 className="mt-4 font-heading text-4xl font-bold leading-[1.08] tracking-tight sm:text-6xl">Atenção não é o problema. É o que vem depois dela.</h1>
        ...
        <section className="border-t border-surface-700 py-10" id="gargalos" aria-labelledby="gargalos-h">
          <h2 id="gargalos-h" className="font-heading text-3xl font-bold">Mais tráfego não conserta um caminho interrompido.</h2>
        ...
        <section className="border-t border-surface-700 py-10" aria-labelledby="raiz">
          <h2 id="raiz" className="font-heading text-3xl font-bold">Ninguém te ensinou a priorizar. Só a comprar mais uma ferramenta.</h2>
        ...
        <section className="border-t border-surface-700 py-10" aria-labelledby="inimigo">
          <h2 id="inimigo" className="font-heading text-3xl font-bold">O vilão não é você. É quem te vende ferramenta antes de te ouvir.</h2>
          <p className="mt-5 max-w-3xl text-lg leading-relaxed text-gray-300">Agência que já chega com pacote fechado, curso que promete o mesmo sistema pra todo mundo, vendedor que empurra a licença mensal antes de entender sua operação — todos vendem a solução deles, não a prioridade da sua empresa. É esse o padrão que a sessão quebra: primeiro o diagnóstico, escrito, com o seu nome — depois, se fizer sentido, a ferramenta.</p>
        </section>
        ...
        <section className="border-t border-surface-700 py-10" aria-labelledby="custo">
          <h2 id="custo" className="font-heading text-3xl font-bold">Cada semana sem prioridade clara é mais uma tentativa no escuro.</h2>
          <p className="mt-5 max-w-3xl text-lg leading-relaxed text-gray-300">Mais uma ferramenta comprada por impulso porque &ldquo;todo mundo tá usando&rdquo;. Mais uma reunião que termina sem decisão. Mais um mês adiando o que já dá pra resolver — porque decidir sem escopo é decidir no escuro, e no escuro a resposta mais fácil é sempre &ldquo;vamos deixar como está&rdquo;.</p>
        </section>
        ...
        <section className="border-t border-surface-700 py-10" aria-labelledby="outro-lado">
          <h2 id="outro-lado" className="font-heading text-3xl font-bold">Com o PRD em mãos, a próxima decisão de tecnologia para de ser aposta.</h2>
          <p className="mt-5 max-w-3xl text-lg leading-relaxed text-gray-300">A mesma pergunta que hoje gera três reuniões vira uma consulta ao documento. Contratar, adaptar ou esperar deixa de ser sensação — vira critério escrito, que você pode mostrar pra sócio, investidor ou pra quem for executar.</p>
        </section>
        ...
        <section className="border-t border-surface-700 py-10" aria-labelledby="prova">
          <h2 id="prova" className="font-heading text-3xl font-bold">Isto é literalmente o que você recebe.</h2>
          <p className="mt-5 max-w-3xl text-lg leading-relaxed text-gray-300">Não é um relatório genérico de 20 páginas. É um documento curto com 4 blocos — os mesmos da seção acima: prioridade, viabilidade, próximo passo e o seu Gambito de Valor documentado. Pronto pra você executar sozinho, com sua equipe, ou com a gente.</p>
        </section>
