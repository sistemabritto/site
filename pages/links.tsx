  ...
  return (
    <>
      <Meta
        ...
        description="Materiais para donos e gestores: presença digital, CRM e uma Sessão de Start para definir o próximo passo da empresa."
        path="/links"
      ...
      <main className="min-h-screen bg-surface-950 px-4 py-12 text-white sm:py-16">
        <div className="mx-auto w-full max-w-xl">
          ...
          <section aria-label="Aplicar na sua empresa" className="mt-8 space-y-4">
            <a href={hrefComUtm('/sessao-de-start', 'bio-arquitetura-v1', utms)}
              ...
              <p className="mt-2 text-sm leading-relaxed text-gray-300">Sessão de Start com Felipe: prioridade, escopo e custos antes de investir em tecnologia.</p>
