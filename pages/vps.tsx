    ...
    <main className="min-h-screen bg-surface-950 px-5 text-white">
      ...
      <div className="mx-auto max-w-5xl">
        ...
        <section className="border-t border-white/10 py-12" aria-labelledby="base">
          ...
          <p className="mt-5 max-w-3xl text-lg leading-relaxed text-gray-300">A aula gratuita mostra como montar a base. Esta oferta é para quem quer contratar a estruturação do ambiente. Se o gargalo ainda é descobrir o que automatizar, comece pela Sessão de Start.</p>
