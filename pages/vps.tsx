    ...
    <main className="min-h-screen bg-surface-950 px-5 text-white">
      ...
      <div className="mx-auto max-w-5xl">
        ...
        <section className="border-t border-white/10 py-12" aria-labelledby="base">
          ...
          <p className="mt-5 max-w-3xl text-lg leading-relaxed text-gray-300">A aula gratuita mostra como montar a base. Esta oferta é para quem quer contratar a estruturação do ambiente. Se o gargalo ainda é descobrir o que automatizar, comece pela Consultoria a Laser.</p>
        ...
        <section className="py-12" aria-labelledby="decisao"><h2 id="decisao" className="text-3xl font-bold">O servidor está decidido. E a solução?</h2><div className="mt-6 grid gap-4 sm:grid-cols-2">
          ...
          <article className="rounded-xl border border-lime-400/25 bg-lime-400/5 p-6"><h3 className="text-xl font-bold">Preciso decidir o que implantar</h3><p className="mt-3 text-lg text-gray-300">Na Consultoria a Laser, definimos prioridade, escopo e integrações antes de contratar infraestrutura ou desenvolvimento.</p><a href="/sessao-de-arquitetura?utm_source=site&utm_medium=internal&utm_campaign=vps&utm_content=arquitetura" onClick={()=>track('vps-arquitetura','definir-escopo')} className="mt-4 inline-flex min-h-11 items-center text-[#a3ff12] underline">Conhecer a sessão · R$ 150 →</a></article>
        </div></section>
