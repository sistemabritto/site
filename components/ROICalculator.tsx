...
/**
 * ROI Calculator — Interactive, glassmorphism card
 * Cálculo baseado em: leads/dia × valor lead × taxa conversão
 */
...
export default function ROICalculator() {
  ...
  const calculation = useMemo(() => {
    ...
    const aiConversionBoost = 1.68; // 68% increase from AI automation
    ...
    const hoursSaved = leadsPerDay * 0.15 * 30; // ~9min per lead saved
    const hourlyRate = 45;
  ...
  return (
    <section id="roi" className="relative py-20 sm:py-32 bg-surface-900 overflow-hidden">
      {/* Aurora BG subtle */}
      ...
      <div ref={reveal} className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 reveal">
        ...
        <div className="glass-strong rounded-3xl p-6 sm:p-10">
          ...
          {/* CTA */}
          <a
            href="https://wa.me/5511914088571?text=Quero+calcular+meu+ROI+com+automação"
            target="_blank"
            rel="noopener noreferrer"
            className="block w-full bg-primary-500 hover:bg-primary-600 text-white text-center py-4 rounded-full font-semibold text-lg transition-all duration-300 cta-glow"
          >
